...
@section('content')
    ...
    <h6 class="mb-4 ps-3">Consultez la liste de tous les clients enregistrés</h6>
    <hr class="mb-4" />
    @if ($errors->any())
    ...
    <div class="card">
        <div class="card-body">
            <div class="table-responsive">
                <table border="1" id="clients-table" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th>
...
@section('script')
    ...
    <script>
        if (document.getElementById("clients-table") && typeof simpleDatatables.DataTable !== 'undefined') {
            ...
            const dataTable = new simpleDatatables.DataTable("#clients-table", {
                searchable: true,
                sortable: true,
