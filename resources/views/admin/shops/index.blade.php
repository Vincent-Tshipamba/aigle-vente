...
@section('content')
    ...
    <h6 class="mb-4 ps-3">Consultez la liste de toutes les boutiques existantes</h6>
    <hr class="mb-4" />
    @if ($errors->any())
    ...
    <div class="card">
        <div class="card-body">
            <div class="table-responsive">
                <table border="1" id="shops-table" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th>
                    ...
                    <tbody>
                        @foreach ($shops as $key => $shop)
                            <tr class="hover:bg-[#f0e9e1]">
                                <td>{{ $key + 1 }}</td>
                                <td onclick="window.location.href='{{ route('admin.shops.show', $shop->id) }}'"
...
@section('script')
    ...
    <script>
        if (document.getElementById("shops-table") && typeof simpleDatatables.DataTable !== 'undefined') {
            ...
            const dataTable = new simpleDatatables.DataTable("#shops-table", {
                searchable: true,
                sortable: true,
