...
@section('content')
    ...
    <div class="page-breadcrumb d-none sm:flex items-center mb-3">
        <nav class="flex px-5 w-full py-3 text-gray-700 rounded-lg bg-[#eaeaebf3] dark:bg-[#1E293B]" aria-label="Breadcrumb">
    ...
    <h6 class="mb-4 ps-3">Consultez la liste de toutes les produits enregistrés dans votre liste des souhaits</h6>
    <hr class="mb-4" />
    @if ($errors->any())
    ...
    <div class="card">
        <div class="card-body">
            <div class="table-responsive">
                <table border="1" id="wishlist-table" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            <th>
                        ...
                        @foreach ($wishlists as $key => $wishlist)
                            <tr
                                ...
                                <td class="flex items-center justify-between"
                                    ...
                                    <svg class="w-6 h-6 text-gray-800 dark:text-white hover:text-[#e38407]"
...
@section('script')
    ...
    <script>
        if (document.getElementById("wishlist-table") && typeof simpleDatatables.DataTable !== 'undefined') {
            ...
            const dataTable = new simpleDatatables.DataTable("#wishlist-table", {
                searchable: true,
                sortable: true,
