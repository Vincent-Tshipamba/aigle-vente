            ...
            <div class="row align-items-center">
                <div class="col-xl-7 col-lg-12 col-md-12 col-12">
                    <div class="tp-breadcrumb">
                        ...
                        <h2 class="tp-breadcrumb__title">Erreur 403</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="eperror__wrapper items-center justify-center mx-auto flex flex-col text-center">
                        ...
                        <div class="tperror__content">
                            <h4 class="tperror__title mb-25">403. Accès refusé</h4>
                            <p>Désolé, vous n'avez pas l'autorisation d'accéder à cette page. Veuillez contacter l'administrateur ou <br> retourner à la page d'accueil.</p>
