                ...
                <div class="header-meta-info flex items-center justify-between space-x-3">
                    ...
                    <div class="header-meta__social flex items-center space-x-3">
                        @auth
                            ...
                            <button class="relative" id="dropdownButtonChatHeader-tab-sticky"
                                data-dropdown-toggle="dropdownChatHeader-tab-sticky">
                            ...
                            <!-- Dropdown chat -->
                            <div id="dropdownChatHeader-tab-sticky"
                                ...
                                <ul class="p-3 text-sm text-gray-700 dark:text-gray-200"
                                    aria-labelledby="dropdownChatHeader-tab-sticky">
                                    @if (Auth::user()->getUnreadCount() > 0)
                                        <li>
                            ...
                            <button id="dropdownUserAvatarButtonHeader-tab-sticky"
                                data-dropdown-toggle="dropdownAvatarHeader-tab-sticky"
                            ...
                            <!-- Dropdown menu -->
                            <div id="dropdownAvatarHeader-tab-sticky"
                                class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-60 dark:bg-gray-700 dark:divide-gray-600">
                                ...
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                    aria-labelledby="dropdownUserAvatarButtonHeader-tab-sticky">
                                    <li>
                                        @if (Auth::user()->client)
                ...
                <div class="header-meta-info flex items-center justify-end space-x-4">
                    <div class="header-meta m-0 flex items-center">
                        <div class="header-meta__social flex items-center space-x-3">
                            @auth
                                <!-- Chat Notification Area -->
                                <button class="relative" id="dropdownButtonChatHeader-mob-sticky"
                                    data-dropdown-toggle="dropdownChatHeader-mob-sticky">
                                    <div class="relative bg-orange-50 p-2 rounded-lg">
                                ...
                                <!-- Dropdown chat -->
                                <div id="dropdownChatHeader-mob-sticky"
                                    class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-60 dark:bg-gray-700 dark:divide-gray-600">
                                    <div class="px-4 py-3 text-sm font-bold text-gray-900 dark:text-white">
                                        Notifications
                                    </div>
                                    <ul class="p-3 text-sm text-gray-700 dark:text-gray-200"
                                        aria-labelledby="dropdownChatHeader-mob-sticky">
                                        @if (Auth::user()->getUnreadCount() > 0)
                                            <li>
                                                <a href="{{ route('profile.edit') }}"
                                                    class="block px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                ...
                                <button id="dropdownUserAvatarButtonHeader-md-lg"
                                    data-dropdown-toggle="dropdownAvatarHeader-md-lg"
                                    class="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                                    type="button">
                                    <span class="sr-only">Open user menu</span>
                                    <img class="w-8 h-8 rounded-full" src="/docs/images/people/profile-picture-3.jpg"
                                ...
                                <div class="header-meta__social flex items-center">
                                    ...
                                    @if (Auth::user()->hasRole('superadmin'))
                                    @else
                                        @if (Auth::check() && !Auth::user()->isSeller() == true)
                                            <a href="{{ route('sellers.create') }}"
                                                class="w-full inline-block px-[10px] py-[15px] bg-[var(--tp-text-primary)] text-[var(--tp-common-white)] text-sm font-semibold rounded-md text-center transition-all duration-300 whitespace-nowrap align-middle touch-manipulation">
                                                Devenir vendeur</a>
                                        @else
