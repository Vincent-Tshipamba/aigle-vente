            ...
            <div class="col-xl-4 col-lg-9">
                <div class="header-meta-info flex items-center space-x-4 justify-end">
                    ...
                    @auth
                                        ...
                                        <button class="relative" id="dropdownButtonChatHeader-xl"
                                            data-dropdown-toggle="dropdownChatHeader-xl">
                                        ...
                                        <div id="dropdownChatHeader-xl"
                                            ...
                                            <ul class="p-3 text-sm text-gray-700 dark:text-gray-200"
                                                aria-labelledby="dropdownChatHeader-xl">
                                                @if (Auth::user()->getUnreadCount() > 0)
                                                                        <li>
                                                                                ...
                                                                                @if (!$conversation?->readBy(auth()?->user()) && !$conversation->lastMessage?->belongsToAuth())
                                                                                    <div class="flex items-center hover:bg-orange-50 hover:cursor-pointer hover:scale-110 hover:ease-in duration-500"
                                                                                        ...
                                                                                        <div class="relative inline-block shrink-0">
                                                                                            <img class="w-12 h-12 rounded-full" src="{{ asset('images/user-avatar.png') }}"
                                                                                        ...
                                                                                        <div class="ms-3 text-sm font-normal">
                                                                                            ...
                                                                                            <span class="text-xs font-medium text-orange-600 dark:text-orange-500">
                    ...
                    @else
                        <a href="#" class="text-md text-black dark:text-gray-200" data-drawer-target="drawer-login"
                            data-drawer-show="drawer-login" data-drawer-placement="bottom" data-drawer-edge="true"
