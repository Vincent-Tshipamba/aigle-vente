            ...
            <div class="tab-pane fade" id="nav-rate" role="tabpanel" aria-labelledby="nav-rate-tab">
                <div class="row row-cols-xxl-5 row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1">
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html"><img src="{{ asset('img/product/home-one/product-5.jpg') }}"
                                        alt="product-thumb"></a>
                                <a class="product-thumb-secondary" href="shop-details.html"><img
                                        src="{{ asset('img/product/home-one/product-6.jpg') }}" alt=""></a>
                                <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                                    <a class="wishlist" href="wishlist.html"><i class="fal fa-heart"></i></a>
                        ...
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                ...
                                <a class="product-thumb-secondary" href="shop-details-2.html"><img
                                        src="{{ asset('img/product/home-one/product-2.jpg') }}" alt=""></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                ...
                                <a class="product-thumb-secondary" href="shop-details-2.html"><img
                                        src="{{ asset('img/product/home-one/product-4.jpg') }}" alt=""></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html"><img src="{{ asset('img/product/home-one/product-19.jpg') }}"
                                        alt="product-thumb"></a>
                                <a class="product-thumb-secondary" href="#"><img
                                        src="{{ asset('img/product/home-one/product-20.jpg') }}" alt=""></a>
                            ...
                            <div class="tpproduct__content">
                                <h3 class="tpproduct__title"><a href="shop-details.html">Weddonix Mediocre Silk
                                        Hat</a></h3>
                                <div class="tpproduct__priceinfo p-relative">
                                    <div class="tpproduct__priceinfo-list">
                                        <span>$31.00</span>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                ...
                                <a class="product-thumb-secondary" href="shop-details-2.html"><img
                                        src="{{ asset('img/product/home-one/product-8.jpg') }}" alt=""></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html"><img src="{{ asset('img/product/home-one/product-9.jpg') }}"
                                        alt="product-thumb"></a>
                                <a class="product-thumb-secondary" href="shop-details-2.html"><img
                                        src="{{ asset('img/product/home-one/product-10.jpg') }}" alt=""></a>
                                <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                                    <a class="wishlist" href="wishlist.html"><i class="fal fa-heart"></i></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html"><img src="{{ asset('img/product/home-one/product-15.jpg') }}"
                                        alt="product-thumb"></a>
                                <a class="product-thumb-secondary" href="shop-details-2.html"><img
                                        src="{{ asset('img/product/home-one/product-16.jpg') }}" alt=""></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html"><img src="{{ asset('img/product/home-one/product-17.jpg') }}"
                                        alt="product-thumb"></a>
                                <a class="product-thumb-secondary" href="shop-details-2.html"><img
                                        src="{{ asset('img/product/home-one/product-18.jpg') }}" alt=""></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <span class="tpproduct__thumb-volt"><i class="fas fa-bolt"></i></span>
                                <a href="shop-details-2.html"><img src="{{ asset('img/product/home-one/product-11.jpg') }}"
                                        alt="product-thumb"></a>
                                <a class="product-thumb-secondary" href="shop-details-2.html"><img
                                        src="{{ asset('img/product/home-one/product-12.jpg') }}" alt=""></a>
                                <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                                    <a class="wishlist" href="wishlist.html"><i class="fal fa-heart"></i></a>
                    ...
                    <div class="col">
                        <div class="tpproduct pb-15 mb-30">
                            <div class="tpproduct__thumb p-relative">
                                <a href="shop-details-2.html"><img src="{{ asset('img/product/home-one/product-13.jpg') }}"
                                        alt="product-thumb"></a>
                                <a class="product-thumb-secondary" href="shop-details-2.html"><img
                                        src="{{ asset('img/product/home-one/product-14.jpg') }}" alt=""></a>
                                <div class="tpproduct__thumb-action">
                                    <a class="comphare" href="#"><i class="fal fa-exchange"></i></a>
                                    <a class="quckview" href="#"><i class="fal fa-eye"></i></a>
                                    <a class="wishlist" href="wishlist.html"><i class="fal fa-heart"></i></a>
