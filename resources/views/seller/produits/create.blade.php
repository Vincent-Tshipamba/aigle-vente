                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    ...
                    <div class="flex flex-col  p-6.5 pb-2 pt-6.5">
                        <div>
                            ...
                            <input type="text" placeholder="Default Input" name="name" id="name" required
                    ...
                    <div class="flex flex-col  px-6.5 py-2 pb-6.5">
                        <div>
                            ...
                            <input type="number" placeholder="2" min="1" name="stock_quantity" id="stock_quantity" required
                                class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                        </div>
                        ...
                        <div
                            ...
                            <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                ...
                                <textarea id="wysiwyg-example" name="description"
                                    class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex flex-col gap-5.5 p-6.5">
                        ...
                        <div>
                            ...
                            <input type="number" id="weight" name="weight" placeholder="Poids (ex : 1kg)" min="1"
                                class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" id="size" name="size" placeholder="Taille (ex : M)" min="1"
                                class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                        </div>
